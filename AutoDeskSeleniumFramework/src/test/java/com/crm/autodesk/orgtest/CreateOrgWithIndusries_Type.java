...
public class CreateOrgWithIndusries_Type {
      ...
      // step 5 : verify Organization name in header of the msg
        ...
        String actIndsutirs = driver.findElement(By.id("dtlview_Industry")).getText();
        if(actIndsutirs.equals(industries)) {
        	System.out.println(industries+"==> is selected==PASS");
        }else {
        	System.out.println(industries+"==> is not selected==FAIL");

        }
        String actType = driver.findElement(By.id("dtlview_Type")).getText();
        if(actType.equals(type)) {
        	System.out.println(type+"==> is selected==PASS");
        }else {
